...
public class EventTemplate {
    ...
    @Column(nullable = false) private Integer periodTypeId;
    @Column(nullable = false) private Boolean periodDayOfWeek;
    @Column(nullable = false) private Boolean periodRepeat;
    @Column(nullable = false) private Boolean periodTimes;

    private LocalDate startDate;
    @Column(nullable = false) private OffsetTime startTime;
